...
{
    //Add 10/01/2012
    public class E_Reporte_Presencia
    {
        public E_Reporte_Presencia()
        {
            PresenciaDetalle = new List<E_Reporte_Presencia_Detalle>();
        }
        ...
        [JsonProperty("s")]
        public List<E_Reporte_Presencia_Detalle> PresenciaDetalle
        {
            get;
            set;
            //get { return PresenciaDetalle; }
            //set { PresenciaDetalle = value; }
        }
