...
{
    public class E_Reporte_Disponibilidad
    {
        ...
        private List<E_Reporte_Disponibilidad_Detalle> disponibilidadDetalle;
        
        [JsonProperty("n")]
        public List<E_Reporte_Disponibilidad_Detalle> DisponibilidadDetalle
        {
            get { return disponibilidadDetalle; }
            set { disponibilidadDetalle = value; }
        }
    }
}
