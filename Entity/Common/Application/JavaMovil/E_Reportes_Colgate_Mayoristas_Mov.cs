...
{
    public class E_Reportes_Colgate_Mayoristas_Mov
    {
        public E_Reportes_Colgate_Mayoristas_Mov() {
            Reportes_Colgate_Mayoristas_Mov_Response = new E_Reportes_Colgate_Mayoristas_Mov_Response();
        }
        [JsonProperty("b")]
        public E_Reportes_Colgate_Mayoristas_Mov_Response Reportes_Colgate_Mayoristas_Mov_Response { get; set; }
    }

    public class E_Reportes_Colgate_Mayoristas_Mov_Response {
        //public E_Reportes_Colgate_Mayoristas_Mov_Response() {
