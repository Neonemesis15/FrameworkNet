...
namespace Lucky.Data
{
    public class Conexion
    {
        ...
        /// CreateBy: Ing.Ditmar Estrada Bernuy
        /// DateBy: 28/02/2011
        /// Este constructor tiene un parametro donde se le indica el id de la base de datos a conectarse.
        /// </summary>
        public Conexion(Int32 Id_DataBase)
        {
            ...
            {
                ConnectionStringSettings settingconection;
                settingconection = ConfigurationManager.ConnectionStrings["ConectaDBLucky"];//Conecta a la BD BDLUCKYCO/DEV
                oSqlConnIN = settingconection.ConnectionString;
            }
                ...
                if (Id_DataBase == 2)
                {
                    ConnectionStringSettings settingconection;
                    settingconection =
                          ConfigurationManager.ConnectionStrings["ConectaDBLucky_Tmp"];//Conecta a la BD Intermedia/DEV
                    oSqlConnIN = settingconection.ConnectionString;
                }

                else if (Id_DataBase == 3)
                {
                    ConnectionStringSettings settingconection;
                    settingconection =
                          ConfigurationManager.ConnectionStrings["ConectaDBLucky_Tmp_Droid"];//Conecta a la BD Intermedia (BDLUCKYTMP) /DEV
                    oSqlConnIN = settingconection.ConnectionString;
                }
                else if (Id_DataBase == 4)
                {
                    ConnectionStringSettings settingconection;
                    settingconection =
                          ConfigurationManager.ConnectionStrings["ConectaDBLucky_BAK"];//Conecta a la BD BDLUCKYPRD_BAK/DEV
                    oSqlConnIN = settingconection.ConnectionString;
                }
                else if (Id_DataBase == 5)
                {
                    ConnectionStringSettings settingconection;
                    settingconection =
                          ConfigurationManager.ConnectionStrings["ConectaDBEasywin"];//Conecta a la BD EasyWin
                    oSqlConnIN = settingconection.ConnectionString;
                }
            }
        }
        ...
        /// Modificacion: Se Agrega el tipo de datos bigint Ing.Carlos Hernández 20/08/2010
        /// </summary>
